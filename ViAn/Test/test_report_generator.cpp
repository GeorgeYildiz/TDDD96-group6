...
void test_report_generator::test_init()
{
    ...
    Bookmark* bookmark1 = new Bookmark(0.1,1,image1, QString::fromStdString(video1_path), dir_path1, QString::fromStdString("test1"));
    Bookmark* bookmark2 = new Bookmark(0.2,2,image2, QString::fromStdString(video2_path), dir_path1, QString::fromStdString("test11"));
